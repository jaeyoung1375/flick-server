package kr.co.jobmoa.auth.controller;

import jakarta.servlet.http.HttpServletRequest;
import jakarta.servlet.http.HttpServletResponse;
import kr.co.jobmoa.auth.dto.MobileRefreshRequestDto;
import kr.co.jobmoa.auth.dto.MobileTokenResponseDto;
import kr.co.jobmoa.auth.dto.OAuthExchangeRequestDto;
import kr.co.jobmoa.auth.dto.TokenResponseDto;
import kr.co.jobmoa.auth.dto.User;
import kr.co.jobmoa.auth.dto.UserProfileDto;
import kr.co.jobmoa.auth.dto.UserResponseDto;
import kr.co.jobmoa.auth.service.AuthService;
import kr.co.jobmoa.auth.util.JwtTokenUtil;
import kr.co.jobmoa.common.code.UserErrorCode;
